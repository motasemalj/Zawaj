...
export default function EmailOtpScreen({ navigation }: any) {
  ...
  const content = (
    <View style={styles.container}>
      <Text style={styles.title}>البريد الإلكتروني (OTP)</Text>
      <TextInput style={styles.input} placeholder="example@email.com" keyboardType="email-address" autoCapitalize="none" value={email} onChangeText={setEmail} returnKeyType="done" />
      {stage === 'request' ? (
